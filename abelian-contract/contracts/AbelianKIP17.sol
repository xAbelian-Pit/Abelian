...
import { IKIP17 } from '@klaytn/contracts/KIP/token/KIP17/IKIP17.sol';
import { Address } from '@klaytn/contracts/utils/Address.sol';
import { Context } from '@klaytn/contracts/utils/Context.sol';
import { Strings } from '@klaytn/contracts/utils/Strings.sol';
import { KIP13, IKIP13 } from '@klaytn/contracts/KIP/utils/introspection/KIP13.sol';
import { IKIP17Metadata } from '@klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Metadata.sol';
import { IKIP17Receiver } from '@klaytn/contracts/KIP/token/KIP17/IKIP17Receiver.sol';
import { IERC721Receiver } from '@klaytn/contracts/token/ERC721/IERC721Receiver.sol';

error BurnCurrentlySupported();
 ...
 * {KIP17Enumerable}.
 */
contract AbelianKIP17 is KIP13, Context, IKIP17, IKIP17Metadata {
